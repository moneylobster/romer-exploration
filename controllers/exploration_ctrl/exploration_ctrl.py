...
#           maybe sum up the sonar readings for each side and speed up that side's wheel the closer obstacles are.
# TODO: make robot save some data with each run: path taken (plot and csv), path computed, medial axis, etc etc. for easier debugging
